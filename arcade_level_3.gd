...
func _ready():
	...
	horizontal_level_2.add_points.connect(add_points_to_player_2)
	...
	patrol_bot.two = true
	patrol_bot2.two = true
	patrol_bot3.two = true
	patrol_bot4.two = true
	patrol_bot5.two = true
	patrol_bot6.two = true
	audioplay.play()
...
func _on_return_area_1_body_entered(body):
	if body is player_grey:
		player.position = Vector2(278,147)
...
func _on_return_area_2_body_entered(body):
	if body is player_grey:
		player.position = Vector2(278,86)
		camera.position = Vector2(642,324)
		player_invulnerability()
		check_player_points()
...
func _on_return_area_3_body_entered(body):
	if body is player_grey:
		player.position = Vector2(880,563)
		camera.position = Vector2(642,324)
		player_invulnerability()
		check_player_points()
...
func _on_return_area_4_body_entered(body):
	if body is player_grey:
		player.position = Vector2(880,498)
		camera.position = Vector2(642,324)
		player_invulnerability()
		check_player_points()
...
func _on_return_area_5_body_entered(body):
	if body is player_grey:
		player.position = Vector2(793,118)
		camera.position = Vector2(642,324)
		player_invulnerability()
		check_player_points()
...
func _on_return_area_6_body_entered(body):
	if body is player_grey:
		player.position = Vector2(962,118)
		camera.position = Vector2(642,324)
		player_invulnerability()
		check_player_points()
...
func _on_return_area_7_body_entered(body):
	if body is player_grey:
		player.position = Vector2(189,530)
		camera.position = Vector2(642,324)
		player_invulnerability()
		check_player_points()
...
func _on_return_area_8_body_entered(body):
	if body is player_grey:
		player.position = Vector2(354,530)
		camera.position = Vector2(642,324)
		player_invulnerability()
		check_player_points()
